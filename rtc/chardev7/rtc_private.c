...
#define RTC_BASE 0x10017000 // 物理地址
...
static int __init rtc_init(void)
{
	...
	rtc_device = device_create(rtc_class,NULL,rtc_chrdev.devno,NULL,"rtc-demo%d",0);
